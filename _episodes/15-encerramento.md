...
[Leslie Lamport](https://pt.wikipedia.org/wiki/Leslie_Lamport) uma vez disse, "Escrever é a forma da natureza de mostrar
o quão desorganizado seu pensamento realmente é."
O mesmo é verdade para programação:
muitas coisas parecem óbvios quando estamos pensando sobre elas mas 
relevam o contrário quando tentamos explicá-las com precisão.

## O Python suporta uma comunidade grande e diversa tanto na academia quanto na indústria.

*   A [documentação do Python 3](https://docs.python.org/pt-br/3/) cobre o principal da linguagem
    e a biblioteca padrão.

*   A [Python Brasil](https://2021.pythonbrasil.org.br/) é a maior conferência nacional da comunidade Python.

*   O ecossistema [SciPy](https://scipy.org) é uma coleção rica de utilidades científicas.
    Também é o nome de uma [série de conferências anuais](https://conference.scipy.org/).

*   Visite também o site do [Projeto Jupyter](https://jupyter.org).

*   A [seção de Python do site Stack Overflow](https://stackoverflow.com/questions/tagged/python?tab=Votes)
    também pode ser de ajuda.